...
public class TestController {
	...
	public String test1(HttpServletRequest request) {
		...
		//return "redirect:/result1";  --> requestScope가 끊겨서 데이터가 전달되지 않는다. 
		return "forward:/result1";  //--> 데이터가 전달되고 그대로 jsp에서도 사용 가능하다.
	}
